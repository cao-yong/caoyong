...
<body>
	...
	<div class="w">
		<div id="logo">
			<a href="javascript:;"> <img src="/images/XBB2.png" alt="康福特博"
	...
	<div id="content">
		<div class="login-wrap">
				...
				<div class="login-form">
					<div class="login-box">
						...
						<div class="mc">
							...
							<div class="coagent">
								<h5>使用合作网站账号登录康福特博：</h5>
								<ul>
									<li><a href="javascript:void(0)"
										clstag="pageclick|keycount|20150112ABD|3">康福特博钱包</a> <span
										class="line">|</span></li>
									<li><a href="javascript:void(0)"
					...
					<div class="qrcode-login">
						<div class="mc">
							<div class="qrcode-desc">
								<h2>
									用康福特博APP <span class="ml5">扫码安全登录</span>
								</h2>
							</div>
			...
			<div class="login-banner" style="background-color: #477eff">
				<div class="w">
					<div id="banner-bg" clstag="pageclick|keycount|20150112ABD|46"
						class="i-inner"
						style="background: url(/images/5965bc06Na12c6ac0.jpg) 0px 0px no-repeat; background-color: #f2f0c0"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div id="footer-2013">
			<div class="links">
				<a rel="nofollow" href="javascript:;"> 关于我们 </a> | <a rel="nofollow"
					...
					href="javascript:;"> 手机版 </a> | <a href="javascript:;"> 友情链接
				</a> | <a href="javascript:;"> 销售联盟 </a> | <a href="javascript:;">
					康福特博社区 </a> | <a href="javascript:;"> 康福特博公益 </a> | <a
					clstag="pageclick|keycount|20150112ABD|9">English Site</a>
			</div>
			<div class="copyright">
				Copyright&#169;2016-2020&nbsp;&nbsp;康福特博&nbsp;版权所有</div>
		</div>
	</div>
