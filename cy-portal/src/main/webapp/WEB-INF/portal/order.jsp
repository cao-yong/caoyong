...
<body id="mainframe">
	...
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="/"><img src="/images/XBB2.png" alt="康福特博商城"></a> <a
					...
					<div class="checkout-steps">
									...
									<div class="shopping-lists" id="shopping-lists">
										...
										<div class="shopping-list ABTest">
											<div class="goods-list">
												...
												<!--配送方式-->
												<div class="goods-tit">
													<h4 class="vendor_name_h" id="0">商家：康福特博自营</h4>
												</div>
													...
													<div class="mode-tab-nav">
														<ul>
															<li class="mode-tab-item curr"><span
																id="jdShip-span-tip" class="m-txt">康福特博快递
										...
										<div class="shopping-list ABTest">
											...
											<div class="dis-modes">
												...
												<!--以下为康福特博第三方配送-->
												<!--以下为第三方配送-->
												<!--如果是SOP快递或者是康福特博中小件商品，但是不支持配送，则采用快递运输-->
												<div class="mode-item mode-tab">
													<h4>配送方式</h4>
													<div class="mode-tab-nav">
														<ul>
						...
						<div class="order-coupon">
							...
							<div class="item" id="orderGiftCardItem">
								<div class="toggle-title">
									<a class="toggler" href="#none" onclick="query_giftCards(2)"><b></b>使用康福特博卡</a>
								</div>
							...
							<div class="item" id="orderEGiftCardItem">
								<div class="toggle-title">
									<a class="toggler" href="#none" onclick="query_giftCards(3)"><b></b>使用康福特博E卡/图书卡（不能与康福特博卡同时使用）</a>
								</div>
			...
			<div class="order-summary">
				...
				<div class="statistic fr">
					...
					<div class="list" id="showGiftCardPrice" style="display: none;">
						<span>康福特博卡/E卡/图书卡：</span><em class="price" id="giftCardPriceId">-￥0.00</em>
					</div>
					<div class="list" id="showUsedJdBean" style="display: none;">
						<span>康福特博豆：</span><em class="price" id="usedJdBeanId">-￥0.00</em>
					</div>
