...
<script type="text/javascript">
	...
	//删除
	var optDelete = function(name, isDisplay, pageNo){
		//至少选择一个
...
<div style="margin-top:15px;"><input class="del-button" type="button" value="删除" onclick="optDelete('${name}', '${isDisplay }', '${page.pageNo }');"/></div>
</div>
</body>
</html>